...
render(filmsWrapperNode, topRatedFilmsWrapper(), `beforeend`);
const topRatedFilmsWrapperNode = document.querySelector(`.films-list--extra .films-list__container`);
console.log('topRatedFilmsWrapperNode', topRatedFilmsWrapperNode);
...
render(filmsWrapperNode, mostCommentedFilmsWrapper(), `beforeend`);
